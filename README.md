...
Automation will generate sitemap and update the branch when a push to 'staging' is detected. Once verified and validated, create a pull request to 'main' and push. Site will be published automatically once pushed to 'main'.
